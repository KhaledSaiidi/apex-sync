...
- Install the Percona operator as its own GitOps unit first, and keep the MySQL cluster CR separate from the operator bundle so upgrades and troubleshooting stay clean.
