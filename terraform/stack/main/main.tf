...
module "argocd" {
  ...
  stateful_resources_pg_backup_bucket              = var.stateful_resources_pg_backup_bucket
  stateful_resources_pg_backup_key_name            = var.stateful_resources_pg_backup_key_name
  stateful_resources_pg_backup_secret_name         = var.stateful_resources_pg_backup_secret_name
  stateful_resources_pg_backup_schedule_full       = var.stateful_resources_pg_backup_schedule_full
  stateful_resources_pg_backup_retention_full      = var.stateful_resources_pg_backup_retention_full
  stateful_resources_pg_backup_retention_full_type = var.stateful_resources_pg_backup_retention_full_type
